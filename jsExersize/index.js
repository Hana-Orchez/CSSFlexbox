...
// Create two new string variables: myFirstName and myLastName and assign them the values of your first and last name, respectively.
 var myFirstName = "Hana";
 var myLastName = "Abdur Rahim";


// 22 Basic JavaScript: Escaping Literal Quotes in Strings
// When you are defining a string you must start and end with a single or double quote95*0+/3. What happens when you need a literal quote: " or ' inside of your string?
...
var myStr = " I am a\"double quoted\"double quotes\"."; // Change this line
...
var myList = [["Chocolate Bar",8] ["Bananas",15],["Apples",7],["Oranges", 10],["Lemons",3]];
...
function fun1() {
  ...
  // Only change code above this line6/
...
function caseInSwitch(val) {
  ...
  // Only change code below this line5
  ...
  function rangeOfNumbers(startNum, endNum) {
    if(endNum - startNum === 0){
      ...
      var numb3rs = rangeOfNumbers(startNum, endNum - 1);
      numbers.push(endNum);
      return numbers;
    }
  };
